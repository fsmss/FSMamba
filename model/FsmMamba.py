...
import pdb
from layers.FSMMM_EncDec import FsmMambaEncoder
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.position_embedder=DataEmbedding(pe_type=configs.pe_type,seq_len=self.seq_len, 
                                            d_model=configs.d_model,c_in=configs.enc_in)                                    
        self.class_strategy = configs.class_strategy
        self.encoder = FsmMambaEncoder(configs)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        _, _, N = x_enc.shape # B L N#torch.Size([32, 96, 7])

        #enc_out = self.enc_embedding(x_enc, x_mark_enc)
        enc_out=self.position_embedder(x_enc.permute(0,2,1))#torch.Size([32, 7, 512])
