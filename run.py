...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='iInformer',
    ...
    #fsm SSM
    parser.add_argument('--pe_type', type=str, default='sincos', help='position embedding type')
    parser.add_argument('--lradj', type=str, default='cosine', help='adjust learning rate   cosine and sigmoid')
